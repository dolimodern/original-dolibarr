...
}	// 1=To block vars specific to distrib, 2 to block all technical parameters
    ...
    ?>
		<td class="label">
			<input type="text"
                   ...
                   id="main_dir"
                   name="main_dir"
                   value="<?php echo $dolibarr_main_document_root; ?>"
        ...
        echo $langs->trans('WithNoSlashAtTheEnd').'<br>';
	...
	<tr>
		...
		<td class="label">
			<input type="text"
                   ...
                   id="main_data_dir"
                   name="main_data_dir"
                   value="<?php echo $dolibarr_main_data_root; ?>"
				<?php if (!empty($force_install_noedit)) {
            echo ' disabled';
        } ?>
			>
	...
	<tr>
		...
		<td class="label">
			<input type="text"
			       ...
			       id="main_url"
                   name="main_url"
			       value="<?php echo $dolibarr_main_url_root; ?> "
				<?php if (!empty($force_install_noedit)) {
        echo ' disabled';
    } ?>
			>
	...
	<tr class="hidesqlite">
		...
		<td class="label">
			<input type="text"
                   id="db_host"
			       name="db_host"
			       value="<?php echo !empty($force_install_dbserver) ? $force_install_dbserver : (!empty($dolibarr_main_db_host) ? $dolibarr_main_db_host : 'localhost'); ?>"
	...
	<tr class="hidesqlite">
		...
		<td class="label">
			<input type="text"
			       name="db_port"
			       id="db_port"
			       value="<?php echo (!empty($force_install_port)) ? $force_install_port : $dolibarr_main_db_port; ?>"
	...
	<tr class="hidesqlite">
		...
		<td class="label">
			<input type="text"
                   id="db_prefix"
			       name="db_prefix"
			       value="<?php echo !empty($force_install_prefix) ? $force_install_prefix : (!empty($dolibarr_main_db_prefix) ? $dolibarr_main_db_prefix : ''); ?>"
	...
	<tr class="hidesqlite">
		...
		<td class="label">
			<input type="text"
                   id="db_user"
			       name="db_user"
			       value="<?php echo (!empty($force_install_databaselogin)) ? $force_install_databaselogin : $dolibarr_main_db_user; ?>"
	...
	<tr class="hidesqlite hideroot">
		...
		<td class="label">
			<input type="text"
			       ...
			       name="db_user_root"
			       class="needroot"
			       value="<?php echo (!empty($force_install_databaserootlogin)) ? $force_install_databaserootlogin : @$db_user_root; ?>"
